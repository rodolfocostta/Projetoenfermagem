...
namespace EnfermariaSenac.Controllers
{
    public class PacientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID_Paciente,Nome_Paciente,Idade,Data_Nasc,Alergico")] Paciente paciente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID_Paciente,Nome_Paciente,Idade,Data_Nasc,Alergico")] Paciente paciente)
        {
